...
public class JwtAuthenticationController {
	...
	public ResponseEntity<?> generateAuthenticationToken(@RequestBody RequestUserLoginDTO authenticationRequest)
			throws Exception {
                System.out.println("Login "+authenticationRequest.getUsername()+" "+ authenticationRequest.getPassword());
